...
$productos = $productoController->obtenerTodasLasproductos();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <tbody>
                    ...
                    foreach ($productos as $producto) {
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a type="button" href="/admin/productos/editar.php?id=<?= $producto['id'] ?>"
                                ...
                                <a type="button" href="/admin/productos/eliminar.php?id=<?= $producto['id'] ?>"
